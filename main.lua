...
--// Settings:
getgenv().on = false -- Use this if your making gui

getgenv().Box_Color = Color3.fromRGB(255, 0, 0)
getgenv().Box_Thickness = 2
getgenv().Box_Transparency = 1 -- 1 Visible, 0 Not Visible
getgenv().Tracers = false
getgenv().Tracer_Color = Color3.fromRGB(255, 0, 0)
getgenv().Tracer_Thickness = 2
getgenv().Tracer_Transparency = 1 -- 1 Visible, 0 Not Visible

getgenv().Autothickness = true -- Makes screen less encumbered

getgenv().Team_Check = true
getgenv().red = Color3.fromRGB(227, 52, 52)
getgenv().green = Color3.fromRGB(88, 217, 24)
