...
local function NewLine()
    ...
    line.Thickness = _G.Box_Thickness
    line.Transparency = _G.Box_Transparency
    return line
end
        ...
        connection = game:GetService("RunService").RenderStepped:Connect(function()
            ...
            for u, x in pairs(lines) do
                if _G.Team_Check == false then
                    x.Color = _G.Box_Color
                end
                if _G.Autothickness == false then
                x.Thickness = Box_Thickness
                end
                x.Transparency = _G.Box_Transparency
            end
            if _G.on and v.Character ~= nil and v.Character:FindFirstChild("Humanoid") ~= nil and v.Character:FindFirstChild("HumanoidRootPart") ~= nil and v.Name ~= player.Name and v.Character.Humanoid.Health > 0 and v.Character:FindFirstChild("Head") ~= nil then
...
game.Players.PlayerAdded:Connect(function(newplr)
    ...
    local function ESP()
        ...
        connection = game:GetService("RunService").RenderStepped:Connect(function()
            ...
            if _G.on and newplr.Character ~= nil and newplr.Character:FindFirstChild("Humanoid") ~= nil and newplr.Character:FindFirstChild("HumanoidRootPart") ~= nil and newplr.Name ~= player.Name and newplr.Character.Humanoid.Health > 0 and newplr.Character:FindFirstChild("Head") ~= nil then
